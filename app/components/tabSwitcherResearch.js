...
export default function TabSwitcherResearch({ compares, onDeleteHistory, onResetHistory }) {
          ...
          {history.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Button
                ...
                className="buttonGlass text-white px-4 py-2 rounded hover:scale-105 transition-transform"
              >
