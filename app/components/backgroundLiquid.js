  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      dispose() {
        ...
        this.window.removeEventListener('touchstart', this._onTouchStart, false)
        this.window.removeEventListener('touchmove', this._onTouchMove, false)
        this.window.removeEventListener('mouseenter', this._onMouseEnter, false)
        this.window.removeEventListener('mouseleave', this._onMouseLeave, false)
